//
//  NSDictionary+ORKRequestSerializationTest.m
//  RestKit
//
...
@interface NSDictionary_ORKRequestSerializationTest : ORKTestCase {
}

@end

@implementation NSDictionary_ORKRequestSerializationTest
