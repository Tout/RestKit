...
@interface ORKPathMatcherTest : ORKTestCase

@end

@implementation ORKPathMatcherTest

- (void)testShouldMatchPathsWithQueryArguments
{
    NSDictionary *arguments = nil;
    ORKPathMatcher *pathMatcher = [ORKPathMatcher matcherWithPath:@"/this/is/my/backend?foo=bar&this=that"];
...
{
    NSDictionary *arguments = nil;
    ORKPathMatcher *pathMatcher = [ORKPathMatcher matcherWithPath:@"/bills/tx/82/SB%2014?apikey=GC12d0c6af"];
...
{
    NSDictionary *arguments = nil;
    ORKPathMatcher *patternMatcher = [ORKPathMatcher matcherWithPattern:@"github.com/:username"];
...
{
    NSDictionary *arguments = nil;
    ORKPathMatcher *patternMatcher = [ORKPathMatcher matcherWithPattern:@"/metadata"];
...
{
    NSDictionary *arguments = nil;
    ORKPathMatcher *pathMatcher = [ORKPathMatcher matcherWithPath:@"/metadata?apikey=GC12d0c6af"];
...
- (void)testShouldCreatePathsFromInterpolatedObjects
{
    ...
    ORKPathMatcher *matcher = [ORKPathMatcher matcherWithPattern:@"/people/:name/:age"];
...
- (void)testShouldCreatePathsFromInterpolatedObjectsWithAddedEscapes
{
    ...
    ORKPathMatcher *matcher = [ORKPathMatcher matcherWithPattern:@"/people/:group/:name?password=:password"];
    NSString *interpolatedPath = [matcher pathFromObject:person];
    assertThat(interpolatedPath, isNot(equalTo(nil)));
...
- (void)testShouldCreatePathsThatIncludePatternArgumentsFollowedByEscapedNonPatternDots
{
    ...
    ORKPathMatcher *matcher = [ORKPathMatcher matcherWithPattern:@"/directory/:filename\\.json"];
