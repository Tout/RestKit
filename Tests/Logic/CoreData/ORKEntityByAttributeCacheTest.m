//
//  ORKEntityByAttributeCacheTest.m
//  RestKit
//
...
@interface ORKEntityByAttributeCacheTest : ORKTestCase
@property (nonatomic, retain) ORKManagedObjectStore *objectStore;
@property (nonatomic, retain) ORKEntityByAttributeCache *cache;
@end

@implementation ORKEntityByAttributeCacheTest
...
- (void)setUp
{
    ...
    NSEntityDescription *entity = [ORKHuman entityDescriptionInContext:self.objectStore.primaryManagedObjectContext];
    self.cache = [[ORKEntityByAttributeCache alloc] initWithEntity:entity
                                                              attribute:@"railsID"
...
{
    NSEntityDescription *entity = [NSEntityDescription entityForName:@"ORKCloud" inManagedObjectContext:self.objectStore.primaryManagedObjectContext];
...
- (void)testContainsObjectReturnsNoForSubEntities
{
    ORKHuman *human = [ORKHuman createInContext:self.objectStore.primaryManagedObjectContext];
    human.railsID = [NSNumber numberWithInteger:12345];
    ORKChild *child = [ORKHuman createInContext:self.objectStore.primaryManagedObjectContext];
...
- (void)testCount
{
    ...
    ORKHuman *human2 = [ORKHuman createInContext:self.objectStore.primaryManagedObjectContext];
    human2.railsID = [NSNumber numberWithInteger:12345];
    ORKHuman *human3 = [ORKHuman createInContext:self.objectStore.primaryManagedObjectContext];
