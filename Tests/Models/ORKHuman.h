...
@interface ORKHuman : NSManagedObject {
}
...
@property (nonatomic, retain) ORKCat *favoriteCat;
...
@interface ORKHuman (CoreDataGeneratedAccessors)
- (void)addCatsObject:(ORKCat *)value;
- (void)removeCatsObject:(ORKCat *)value;
