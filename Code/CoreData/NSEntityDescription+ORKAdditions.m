//
//  NSEntityDescription+ORKAdditions.m
//  RestKit
//
...
NSString * const ORKEntityDescriptionPrimaryKeyAttributeUserInfoKey = @"primaryKeyAttribute";
NSString * const ORKEntityDescriptionPrimaryKeyAttributeValuePredicateSubstitutionVariable = @"PRIMARY_KEY_VALUE";

static char primaryKeyAttributeNameKey, primaryKeyPredicateKey;

@implementation NSEntityDescription (ORKAdditions)
...
- (NSString *)primaryKeyAttributeName
{
    ...
    if (! primaryKeyAttribute) {
        primaryKeyAttribute = [self.userInfo valueForKey:ORKEntityDescriptionPrimaryKeyAttributeUserInfoKey];
...
- (NSPredicate *)predicateForPrimaryKeyAttributeWithValue:(id)value
{
    ...
    NSDictionary *variables = [NSDictionary dictionaryWithObject:substitutionValue
                                                          forKey:ORKEntityDescriptionPrimaryKeyAttributeValuePredicateSubstitutionVariable];
