...
@class ORKEntityByAttributeCache;

/**
 Instances of ORKInMemoryEntityCache provide an in-memory caching mechanism for
 ...
 */
@interface ORKEntityCache : NSObject
...
/**
 ...
 @see [ORKEntityByAttributeCache flush]
 */
- (void)flush;
