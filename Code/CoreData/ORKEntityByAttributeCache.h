...
/**
 Instances of ORKEntityByAttributeCache provide an in-memory caching mechanism
 ...
 ORKEntityByAttributeCache instances are used by the ORKEntityCache to provide
 caching for multiple entities at once.

 @see ORKEntityCache
 */
@interface ORKEntityByAttributeCache : NSObject
