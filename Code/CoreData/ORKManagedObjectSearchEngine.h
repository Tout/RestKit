//
//  ORKManagedObjectSearchEngine.h
//  RestKit
//
...
#import "ORKSearchEngine.h"

@interface ORKManagedObjectSearchEngine : NSObject

/**
 * The type of searching to perform. Can be either ORKSearchModeAnd or ORKSearchModeOr.
 *
 * Defaults to ORKSearchModeOr
 */
 ...
 * searchableAttributes (defined for an ORKSearchableManagedObject)
 */
