//
//  ORKManagedObjectSearchEngine.m
//  RestKit
//
...
@implementation ORKManagedObjectSearchEngine
...
+ (id)searchEngine
{
    ORKManagedObjectSearchEngine *searchEngine = [[[ORKManagedObjectSearchEngine alloc] init] autorelease];
    return searchEngine;
}
...
- (NSPredicate *)predicateForSearch:(NSString *)searchText
{
    ...
    NSArray *searchTerms = [ORKManagedObjectSearchEngine tokenizedNormalizedString:searchQuery];
    [searchQuery release];
