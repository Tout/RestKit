...
/**
 An ORKManagedObjectMapping defines an object mapping with a Core Data destination
 entity.
 */
@interface ORKManagedObjectMapping : ORKObjectMapping {
...
/**
 ...
 If the primaryKeyAttribute is set on an ORKManagedObjectMapping that targets an entity with a
...
/**
 The ORKManagedObjectStore containing the Core Data entity being mapped
 */
@property (nonatomic, readonly) ORKManagedObjectStore *objectStore;
