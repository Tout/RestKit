 ...
 * Notifications
 */
extern NSString * const ORKManagedObjectStoreDidFailSaveNotification;

///////////////////////////////////////////////////////////////////

@protocol ORKManagedObjectStoreDelegate
@optional

- (void)managedObjectStore:(ORKManagedObjectStore *)objectStore didFailToCreatePersistentStoreCoordinatorWithError:(NSError *)error;

- (void)managedObjectStore:(ORKManagedObjectStore *)objectStore didFailToDeletePersistentStore:(NSString *)pathToStoreFile error:(NSError *)error;

- (void)managedObjectStore:(ORKManagedObjectStore *)objectStore didFailToCopySeedDatabase:(NSString *)seedDatabase error:(NSError *)error;

- (void)managedObjectStore:(ORKManagedObjectStore *)objectStore didFailToSaveContext:(NSManagedObjectContext *)context error:(NSError *)error exception:(NSException *)exception;

@end

///////////////////////////////////////////////////////////////////

@interface ORKManagedObjectStore : NSObject

// The delegate for this object store
@property (nonatomic, assign) NSObject<ORKManagedObjectStoreDelegate> *delegate;
...
/**
 Deletes the SQLite file backing an ORKManagedObjectStore instance at a given path.
...
/**
 Deletes the SQLite file backing an ORKManagedObjectStore instance with a given
 ...
 */
@property (nonatomic, retain) NSObject<ORKManagedObjectCaching> *cacheStrategy;
