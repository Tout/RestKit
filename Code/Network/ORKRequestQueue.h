...
/**
 ...
 @return An autoreleased ORKRequestQueue object.
 */
+ (id)requestQueue;
...
/**
 ...
 @return A new retained ORKRequestQueue with the given name or nil if one already
...
/**
 ...
 @param name A symbolic name for the queue.
 @return An existing ORKRequestQueue with the given name or a new queue if none
 currently exist.
 */
...
/**
 ...
 [ORKRequestQueue requestQueueWithName:]
 */
...
/**
 ...
 If the object implements the ORKRequestQueueDelegate protocol, it will receive
 request lifecycle event messages.
 */
@property (nonatomic, assign) id<ORKRequestQueueDelegate> delegate;
 ...
 */
- (void)cancelRequestsWithDelegate:(id<ORKRequestDelegate>)delegate;
 ...
 */
- (void)abortRequestsWithDelegate:(id<ORKRequestDelegate>)delegate;
...
/**
 ...
 @bug **DEPRECATED** in v0.10.0: All ORKClient instances now own their own
 individual request queues.

 @see [ORKClient requestQueue]
 @return Global request queue.
 */
+ (ORKRequestQueue *)sharedQueue DEPRECATED_ATTRIBUTE;
 ...
 */
+ (void)setSharedQueue:(ORKRequestQueue *)requestQueue DEPRECATED_ATTRIBUTE;

@end


/**
 Lifecycle events for an ORKRequestQueue
 */
@protocol ORKRequestQueueDelegate <NSObject>
@optional
 ...
 */
- (void)requestQueueWasSuspended:(ORKRequestQueue *)queue;
 ...
 */
- (void)requestQueueWasUnsuspended:(ORKRequestQueue *)queue;
 ...
 */
- (void)requestQueue:(ORKRequestQueue *)queue willSendRequest:(ORKRequest *)request;
 ...
 */
- (void)requestQueue:(ORKRequestQueue *)queue didLoadResponse:(ORKResponse *)response;
 ...
 */
- (void)requestQueue:(ORKRequestQueue *)queue didCancelRequest:(ORKRequest *)request;
...
/**
 ...
 @param error An NSError object containing the ORKRestKitError that caused the
 request to fail.
 */
- (void)requestQueue:(ORKRequestQueue *)queue didFailRequest:(ORKRequest *)request withError:(NSError *)error;
 ...
 */
@interface UIApplication (ORKNetworkActivity)
