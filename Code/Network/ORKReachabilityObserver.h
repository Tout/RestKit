 ...
 */
extern NSString * const ORKReachabilityDidChangeNotification;

/**
 User Info key for accessing the SCNetworkReachabilityFlags from a
 ORKReachabilityDidChangeNotification
 */
extern NSString * const ORKReachabilityFlagsUserInfoKey;

/**
 Posted when network state has been initially determined
 */
extern NSString * const ORKReachabilityWasDeterminedNotification;

typedef enum {
    /**
     Network reachability not yet known
     */
    ORKReachabilityIndeterminate,
    /**
     Network is not reachable
     */
    ORKReachabilityNotReachable,
    /**
     Network is reachable via a WiFi connection
     */
    ORKReachabilityReachableViaWiFi,
    /**
     Network is reachable via a "wireless wide area network" (WWAN). i.e. GPRS,
     Edge, 3G, etc.
     */
    ORKReachabilityReachableViaWWAN
} ORKReachabilityNetworkStatus;
...
/**
 ...
 `[ORKReachabilityDidChangeNotifications](ORKReachabilityDidChangeNotification)`
 ...
 */
@interface ORKReachabilityObserver : NSObject {
...
/**
 Creates and returns a ORKReachabilityObserver instance observing reachability
...
/**
 Returns a ORKReachabilityObserver instance observing reachability changes to the
...
/**
 ...
 When initialized, ORKReachabilityObserver instances are in an indeterminate
...
/**
 ...
 @return Status of the network as ORKReachabilityNetworkStatus
 */
@property (nonatomic, readonly) ORKReachabilityNetworkStatus networkStatus;
...
/**
 ...
 Flags can also be directly obtained via [ORKReachabilityObserver getFlags]
