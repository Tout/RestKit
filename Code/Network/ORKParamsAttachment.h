...
/**
 ...
 stacked together within the ORKParams document to allow for uploading files via
 HTTP.

 Typically, interactions with the ORKParamsAttachment are accomplished through
 the ORKParams class and there shouldn't be much need to deal directly with this
 class.
 */
@interface ORKParamsAttachment : NSObject {
    @private
    NSData *_body;
...
/**
 ...
 and prepare the attachment for writing to an ORKParams stream.
 */
- (void)open;
