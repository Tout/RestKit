 ...
 */
@interface ORKResponse : NSObject {
...
/**
 ...
 @return An ORKResponse object with the request parameter set.
 */
...
/**
 ...
 @return An ORKResponse object with the request, body, and header parameters set.
 */
...
/**
 ...
 @return An ORKResponse object with the results of the synchronous request
 ...
 */
@property (nonatomic, assign, readonly) ORKRequest *request;
...
/**
 Indicates whether the response was loaded from ORKCache
