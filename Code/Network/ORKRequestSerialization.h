...
/**
 A simple implementation of the ORKRequestSerializable protocol suitable for
 wrapping a MIME Type string and HTTP Body into a format that can be sent as the
 params of an ORKRequest.

 @see ORKRequestSerializable
 */
@interface ORKRequestSerialization : NSObject <ORKRequestSerializable>
...
/**
 ...
 @return An autoreleased ORKRequestSerialization object with the data and MIME
 type set.
 */
...
/**
 ...
 @param data An NSData object to initialize the serialization with.
 @param MIMEType A string of the MIME type of the provided data.
 @return An ORKRequestSerialization object with the data and MIME type set.
 */
