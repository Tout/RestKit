 ...
 */
@protocol ORKRequestSerializable <NSObject>
...
/**
 ...
 @bug **DEPRECATED** in v0.10.0: Implement [ORKRequestSerializable HTTPHeaderValueForContentType]
 instead.
 @return A string value of the Content-Type header for the HTTP body.
 */
