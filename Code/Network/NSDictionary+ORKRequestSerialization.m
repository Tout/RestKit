//
//  NSDictionary+ORKRequestSerialization.m
//  RestKit
//
...
ORK_FIX_CATEGORY_BUG(NSDictionary_ORKRequestSerialization)

@implementation NSDictionary (ORKRequestSerialization)

- (NSString *)HTTPHeaderValueForContentType
{
    return ORKMIMETypeFormURLEncoded;
}
