...
/**
 ORKClient exposes the low level client interface for working with HTTP servers
 and RESTful services. It wraps the request/response cycle with a clean, simple
 interface.

 ORKClient can be thought of as analogous to a web browser or other HTTP user
 ...
 layer, a user will generally construct and dispatch all ORKRequest objects via
 the interfaces exposed by ORKClient.


 ### Base URL and Resource Paths

 Core to an effective utilization of ORKClient is an understanding of the Base
 URL and Resource Path concepts. The Base URL forms the common beginning part of
 a complete URL string that is used to access a remote web service. ORKClient
 ...
 Note that memory management of requests sent via ORKClient instances are
 ...
 ORKClient and ORKRequest support the serialization of objects into payloads to be
 ...
 provided via the ORKRequestSerializable protocol and is not specific to
 ...
 request via [ORKClient requestWithResourcePath:] and work with the ORKRequest
 object directly.

 @see ORKRequest
 @see ORKResponse
 @see ORKRequestQueue
 @see ORKRequestSerializable
 */
@interface ORKClient : NSObject <ORKConfigurationDelegate> {
...
/**
 ...
 to this base URL.
 @return A configured ORKClient instance ready to send requests
 */
...
/**
 ...
 @bug **DEPRECATED** in version 0.9.4: Use [ORKClient clientWithBaseURLString:]
 ...
 @return A configured ORKClient instance ready to send requests
 */
+ (ORKClient *)clientWithBaseURL:(NSString *)baseURL username:(NSString *)username password:(NSString *)password DEPRECATED_ATTRIBUTE;
...
/**
 ...
 @see requestCache
 */
@property (nonatomic, retain) ORKURL *baseURL;
...
/**
 ...
 This is passed along to ORKRequest if set.  If it isn't set, it will default
 to ORKRequest's default timeoutInterval.

 *Default*: Falls through to ORKRequest's timeoutInterval
 */
...
/**
 ...
 This encoding will be used by the ORKResponse when creating the body content
 */
...
/**
 ...
 - `ORKRequestAuthenticationTypeNone`: Disable the use of authentication
 - `ORKRequestAuthenticationTypeHTTP`: Use NSURLConnection's HTTP AUTH
 auto-negotiation
 - `ORKRequestAuthenticationTypeHTTPBasic`: Force the use of HTTP Basic
 ...
 - `ORKRequestAuthenticationTypeOAuth1`: Enable the use of OAuth 1.0
 authentication. OAuth1ConsumerKey, OAuth1ConsumerSecret, OAuth1AccessToken,
 and OAuth1AccessTokenSecret must be set.
 - `ORKRequestAuthenticationTypeOAuth2`: Enable the use of OAuth 2.0
 authentication. OAuth2AccessToken must be set.

 **Default**: ORKRequestAuthenticationTypeNone

 */
@property (nonatomic, assign) ORKRequestAuthenticationType authenticationType;
...
/**
 ...
 ORKRequestAuthenticationTypeHTTP or ORKRequestAuthenticationTypeHTTPBasic.
...
/**
 ...
 ORKRequestAuthenticationTypeOAuth1
...
/**
 ...
 Used to build an Authorization header when authenticationType is
 ORKRequestAuthenticationTypeOAuth2
...
/**
 An instance of ORKReachabilityObserver used for determining the availability of
 network access.

 Initialized using [ORKReachabilityObserver reachabilityObserverForInternet] to
 ...
 */
@property (nonatomic, retain) ORKReachabilityObserver *reachabilityObserver;
...
/**
 ...
 Equivalent to executing `[ORKClient isNetworkReachable]` on the sharedClient
...
/**
 ...
 @bug **DEPRECATED** in v0.10.0: Use [ORKClient isNetworkReachable]
 @see ORKReachabilityObserver
 @return YES if the remote host is accessible
 */
 ...
 */
@property (nonatomic, retain) ORKRequestCache *cache DEPRECATED_ATTRIBUTE;

/**
 An instance of the request cache used to store/load cacheable responses for
 requests sent through this client
 */
@property (nonatomic, retain) ORKRequestCache *requestCache;

/**
 The timeout interval within which the requests should not be sent and the
 cached response should be used.

 This is only used if the cache policy includes ORKRequestCachePolicyTimeout.
 */
...
/**
 ...
 - `ORKRequestCachePolicyNone`: Never use the cache.
 - `ORKRequestCachePolicyLoadIfOffline`: Load from the cache when offline.
 - `ORKRequestCachePolicyLoadOnError`: Load from the cache if an error is
 encountered.
 - `ORKRequestCachePolicyEtag`: Load from the cache if there is data stored and
 the server returns a 304 (Not Modified) response.
 - `ORKRequestCachePolicyEnabled`: Load from the cache whenever data has been
 stored.
 - `ORKRequestCachePolicyTimeout`: Load from the cache if the
 cacheTimeoutInterval is reached before the server responds.

 @see ORKRequest
 */
@property (nonatomic, assign) ORKRequestCachePolicy cachePolicy;
...
/**
 ...
 `ORKClientRequestCache-host` appended.
 */
...
/**
 ...
 @param client An ORKClient instance to configure as the new shared instance
 */
...
/**
 ...
 @bug **DEPRECATED** in v0.10.0: Use [ORKClient requestWithResourcePath:] instead.
 ...
 @return A fully configured ORKRequest instance ready for sending.
 @see ORKRequestDelegate
 */
- (ORKRequest *)requestWithResourcePath:(NSString *)resourcePath delegate:(NSObject<ORKRequestDelegate> *)delegate DEPRECATED_ATTRIBUTE;
...
/**
 ...
 @return The ORKRequest object built and sent to the remote system
 */
- (ORKRequest *)get:(NSString *)resourcePath delegate:(NSObject<ORKRequestDelegate> *)delegate;
...
/**
 ...
 @return The ORKRequest object built and sent to the remote system
 */
- (ORKRequest *)get:(NSString *)resourcePath queryParameters:(NSDictionary *)queryParameters delegate:(NSObject<ORKRequestDelegate> *)delegate;
...
/**
 ...
 The form parameters passed here must conform to ORKRequestSerializable, such as
 an instance of ORKParams.

 @see ORKParams
 @param resourcePath The resourcePath to target the request at
 @param params A ORKRequestSerializable object to use as the body of the request
 @param delegate A delegate object to inform of the results
 @return The ORKRequest object built and sent to the remote system
 @see ORKRequestSerializable
 */
- (ORKRequest *)post:(NSString *)resourcePath params:(NSObject<ORKRequestSerializable> *)params delegate:(NSObject<ORKRequestDelegate> *)delegate;
...
/**
 ...
 @see ORKRequestSerializable
 */
- (ORKRequest *)put:(NSString *)resourcePath params:(NSObject<ORKRequestSerializable> *)params delegate:(NSObject<ORKRequestDelegate> *)delegate;
...
/**
 ...
 @return The ORKRequest object built and sent to the remote system
 */
- (ORKRequest *)delete:(NSString *)resourcePath delegate:(NSObject<ORKRequestDelegate> *)delegate;
...
/**
 ...
 @bug **DEPRECATED** in v0.10.0: Use [ORKURL URLByAppendingResourcePath:]
...
/**
 ...
 @bug **DEPRECATED**: Use `[ORKURL URLByAppendingResourcePath:] absoluteString`
...
/**
 ...
 @bug **DEPRECATED**: Use [ORKURL URLByAppendingQueryParameters:]
...
/**
 ...
 @bug **DEPRECATED**: Use [ORKURL URLByAppendingResourcePath:queryParameters:]
...
/**
 ...
 the shared ORKClient instance is configured with.

 Shortcut for calling `[[ORKClient sharedClient] URLForResourcePath:@"/some/path"]`

 @bug **DEPRECATED** in v0.10.0: Use [[ORKClient sharedClient].baseURL
 ...
 */
NSURL *ORKMakeURL(NSString *resourcePath) DEPRECATED_ATTRIBUTE;

/**
 Returns an NSString with the specified resource path appended to the base URL
 that the shared ORKClient instance is configured with

 Shortcut for calling
 `[[ORKClient sharedClient] URLPathForResourcePath:@"/some/path"]`

 @bug **DEPRECATED** in v0.10.0: Use
 [[[ORKClient sharedClient].baseURL URLByAppendingResourcePath:] absoluteString]
 @param resourcePath The resource path to append to the baseURL of the
 `[ORKClient sharedClient]`
 @return A fully constructed NSURL consisting of baseURL of the shared client
 singleton and the supplied resource path
 */
NSString *ORKMakeURLPath(NSString *resourcePath) DEPRECATED_ATTRIBUTE;
...
/**
 ...
 ORKMakePathWithObjectAddingEscapes.

 For example, given an 'article' object with an 'articleID' property of 12345
 and a 'name' of Blake, ORKMakePathWithObject(@"articles/:articleID/:name", article)
 ...
 @see ORKMakePathWithObjectAddingEscapes
 */
NSString *ORKMakePathWithObject(NSString *path, id object) DEPRECATED_ATTRIBUTE;
...
/**
 ...
 For example, given an 'article' object with an 'articleID' property of 12345
 and a 'code' of "This/That", `ORKMakePathWithObjectAddingEscapes(@"articles/:articleID/:code", article, YES)`
 ...
 actual property values.
 */
NSString *ORKMakePathWithObjectAddingEscapes(NSString *pattern, id object, BOOL addEscapes) DEPRECATED_ATTRIBUTE;
...
/**
 ...
 @return A new resource path with the query parameters appended.
 */
NSString *ORKPathAppendQueryParams(NSString *resourcePath, NSDictionary *queryParams) DEPRECATED_ATTRIBUTE;
