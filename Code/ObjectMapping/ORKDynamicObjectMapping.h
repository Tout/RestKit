 ...
 */
@protocol ORKDynamicObjectMappingDelegate <NSObject>
...
typedef ORKObjectMapping *(^ORKDynamicObjectMappingDelegateBlock)(id);
#endif
 ...
 */
@interface ORKDynamicObjectMapping : ORKObjectMappingDefinition {
...
/**
 ...
 @see ORKDynamicObjectMappingDelegate
 */
@property (nonatomic, assign) id<ORKDynamicObjectMappingDelegate> delegate;
...
/**
 ...
 to apply to the mappable data.
 */
@property (nonatomic, copy) ORKDynamicObjectMappingDelegateBlock objectMappingForDataBlock;
#endif
 ...
 */
+ (ORKDynamicObjectMapping *)dynamicMappingUsingBlock:(void(^)(ORKDynamicObjectMapping *dynamicMapping))block;
+ (ORKDynamicObjectMapping *)dynamicMappingWithBlock:(void(^)(ORKDynamicObjectMapping *dynamicMapping))block DEPRECATED_ATTRIBUTE;
...
/**
 ...
 is 'female' we want to use the Girl class. We might define our dynamic mapping like so:
    ...
    ORKDynamicObjectMapping *mapping = [ORKDynamicObjectMapping dynamicMapping];
...
/**
 Invoked by the ORKObjectMapper and ORKObjectMappingOperation to determine the appropriate ORKObjectMapping to use
 when mapping the specified dictionary of mappable data.
 */
- (ORKObjectMapping *)objectMappingForDictionary:(NSDictionary *)dictionary;
...
/**
 ...
 @deprecated
 */
@interface ORKObjectDynamicMapping : ORKDynamicObjectMapping
@end
