...
@implementation ORKObjectRouter
...
- (NSString *)HTTPVerbForMethod:(ORKRequestMethod)method
{
    switch (method) {
...
- (void)routeClass:(Class)theClass toResourcePathPattern:(NSString *)resourcePath forMethod:(ORKRequestMethod)method
{
    [self routeClass:theClass toResourcePath:resourcePath forMethod:method escapeRoutedPath:YES];
}

- (void)routeClass:(Class)theClass toResourcePathPattern:(NSString *)resourcePath forMethod:(ORKRequestMethod)method escapeRoutedPath:(BOOL)addEscapes
{
...
#pragma mark ORKRouter

- (NSString *)resourcePathForObject:(NSObject *)object method:(ORKRequestMethod)method
{
    NSString *methodName = [self HTTPVerbForMethod:method];
    ...
    if (routeEntry) {
        ...
        ORKPathMatcher *matcher = [ORKPathMatcher matcherWithPattern:[routeEntry objectForKey:@"resourcePath"]];
...
@implementation ORKObjectRouter (CompatibilityAliases)
...
- (void)routeClass:(Class)objectClass toResourcePath:(NSString *)resourcePath forMethod:(ORKRequestMethod)method
{
    [self routeClass:objectClass toResourcePathPattern:resourcePath forMethod:method];
}

- (void)routeClass:(Class)objectClass toResourcePath:(NSString *)resourcePath forMethod:(ORKRequestMethod)method escapeRoutedPath:(BOOL)addEscapes
{
