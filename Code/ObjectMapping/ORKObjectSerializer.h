...
/**
 ...
 transformed object is then enclosed in an ORKRequestSerializable representation
 that is suitable for inclusion in an ORKRequest.
 */
@interface ORKObjectSerializer : NSObject <ORKObjectMappingOperationDelegate>

@property (nonatomic, readonly) id object;
@property (nonatomic, readonly) ORKObjectMapping *mapping;
...
/**
 ...
 then encoding it into the destination MIME Type via an instance of ORKParser that is registered
...
/**
 ...
 be used as the params of an ORKRequest or ORKObjectLoader
 */
