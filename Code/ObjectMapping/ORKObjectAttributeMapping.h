...
@interface ORKObjectAttributeMapping : NSObject <NSCopying>
...
/**
 ...
 When an object mapping is configured to target mapping of nested content via [ORKObjectMapping mapKeyOfNestedDictionaryToAttribute:], a special attribute mapping is defined that targets
 ...
 @see [ORKObjectMapping mapKeyOfNestedDictionaryToAttribute:]
