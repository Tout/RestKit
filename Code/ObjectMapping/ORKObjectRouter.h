...
/**
 * An implementation of the ORKRouter protocol that is suitable for use in either
 ...
 */
@interface ORKObjectRouter : NSObject <ORKRouter> {
 ...
 * @see ORKPathMatcher
 */
- (void)routeClass:(Class)objectClass toResourcePathPattern:(NSString *)resourcePathPattern forMethod:(ORKRequestMethod)method;
 ...
 * @see ORKPathMatcher
 */
- (void)routeClass:(Class)objectClass toResourcePathPattern:(NSString *)resourcePathPattern forMethod:(ORKRequestMethod)method escapeRoutedPath:(BOOL)addEscapes;

@end

// Method signatures being phased out
@interface ORKObjectRouter (CompatibilityAliases)
