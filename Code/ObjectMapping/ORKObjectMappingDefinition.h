...
/**
 ORKObjectMappingDefinition is an abstract class for objects defining RestKit object mappings.
 Its interface is common to all object mapping classes, including its concrete subclasses
 ORKObjectMapping and ORKDynamicObjectMapping.
 */
@interface ORKObjectMappingDefinition : NSObject
