...
typedef void(^ORKTableViewCellForObjectAtIndexPathBlock)(UITableViewCell *cell, id object, NSIndexPath *indexPath);
typedef CGFloat(^ORKTableViewHeightOfCellForObjectAtIndexPathBlock)(id object, NSIndexPath *indexPath);
typedef void(^ORKTableViewAccessoryButtonTappedForObjectAtIndexPathBlock)(UITableViewCell *cell, id object, NSIndexPath *indexPath);
typedef NSString *(^ORKTableViewTitleForDeleteButtonForObjectAtIndexPathBlock)(UITableViewCell *cell, id object, NSIndexPath *indexPath);
typedef UITableViewCellEditingStyle(^ORKTableViewEditingStyleForObjectAtIndexPathBlock)(UITableViewCell *cell, id object, NSIndexPath *indexPath);
typedef NSIndexPath *(^ORKTableViewTargetIndexPathForMoveBlock)(UITableViewCell *cell, id object, NSIndexPath *sourceIndexPath, NSIndexPath *destIndexPath);
typedef void(^ORKTableViewAnonymousBlock)();
typedef void(^ORKTableViewCellBlock)(UITableViewCell *cell);
...
/**
 ...
 Cell mappings are used to drive table view cells within an ORKTableController
 ...
 @see ORKTableController
 */
@interface ORKTableViewCellMapping : ORKObjectMapping {
@protected
...
/**
 ...
 Use of this property requires that ORKTableController instance you are
 ...
 */
@property (nonatomic, copy) ORKTableViewCellForObjectAtIndexPathBlock onSelectCellForObjectAtIndexPath;
 ...
 */
@property (nonatomic, copy) ORKTableViewAnonymousBlock onSelectCell;
 ...
 */
@property (nonatomic, copy) ORKTableViewCellForObjectAtIndexPathBlock onCellWillAppearForObjectAtIndexPath;
...
/**
 ...
 represented in the cell, and the NSIndexPath for the row position the cell will be appearing at.
 */
@property (nonatomic, copy) ORKTableViewHeightOfCellForObjectAtIndexPathBlock heightOfCellForObjectAtIndexPath;
...
/**
 ...
 represented in the cell, and the NSIndexPath for the row position the cell will be appearing at.
 */
@property (nonatomic, copy) ORKTableViewAccessoryButtonTappedForObjectAtIndexPathBlock onTapAccessoryButtonForObjectAtIndexPath;
...
/**
 ...
 represented in the cell, and the NSIndexPath for the row position the cell will be appearing at.
 */
@property (nonatomic, copy) ORKTableViewTitleForDeleteButtonForObjectAtIndexPathBlock titleForDeleteButtonForObjectAtIndexPath;
...
/**
 ...
 represented in the cell, and the NSIndexPath for the row position the cell will be appearing at.
 */
@property (nonatomic, copy) ORKTableViewEditingStyleForObjectAtIndexPathBlock editingStyleForObjectAtIndexPath;

@property (nonatomic, copy) ORKTableViewTargetIndexPathForMoveBlock targetIndexPathForMove;
...
/**
 Creates and returns an ORKTableCellMapping instance configured with the default cell mappings.

 @return An ORKTableCellMapping instance with default mappings applied.
 @see [ORKTableCellMapping addDefaultMappings]
 */
 ...
 */
+ (id)cellMappingUsingBlock:(void (^)(ORKTableViewCellMapping *cellMapping))block;
...
/**
 ...
 These properties are exposed on the ORKTableItem class for convenience in quickly building static
 table views/
