...
#import "ORKControlTableViewCell.h"

@implementation ORKControlTableItem

@synthesize control = _control;

+ (id)tableItemWithControl:(UIControl *)control
{
    ORKControlTableItem *tableItem = [self tableItem];
...
- (id)init
{
    ...
    if (self) {
        ...
        self.cellMapping.cellClass = [ORKControlTableViewCell class];
...
{
    NSAssert(control, @"Cannot add a nil control to a ORKControlTableItem");
    [control retain];
    [_control release];
    _control = control;
}
