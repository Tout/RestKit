...
@implementation ORKTableViewCellMappings
...
- (void)setCellMapping:(ORKTableViewCellMapping *)cellMapping forClass:(Class)objectClass
{
...
- (ORKTableViewCellMapping *)cellMappingForClass:(Class)objectClass
{
    // Exact match
    ORKTableViewCellMapping *cellMapping = [_cellMappings objectForKey:NSStringFromClass(objectClass)];
