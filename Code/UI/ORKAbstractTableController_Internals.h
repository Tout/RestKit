//
//  ORKAbstractTableController_Internals.h
//  RestKit
//
...
/*
 A private continuation class for subclass implementations of ORKAbstractTableController
 */
@interface ORKAbstractTableController () <ORKObjectLoaderDelegate, ORKRefreshTriggerProtocol>
...
@property (nonatomic, assign, readwrite) ORKTableControllerState state;
@property (nonatomic, readwrite, retain) ORKObjectLoader *objectLoader;
...
@property (nonatomic, readonly) ORKCache *cache;
