 ...
 */
@interface ORKTableItem : NSObject
...
/**
 ...
 into your table cells without resorting to subclassing ORKTableItem:
 ...
 Note that this is an instance of ORKMutableBlockDictionary -- a dictionary capable of
 storing executable block values that will be resolved at mapping time.

 For convenience, you can also perform key-value coding operations on instances of ORKTableItem
 ...
 @see ORKMutableBlockDictionary
 */
@property (nonatomic, retain) ORKMutableBlockDictionary *userData;

/**
 Informal protocol implementation. Any object that responds to the `cellMapping` message
 and returns an ORKTableViewCellMapping will be mapped into a table view cell according to
 the rules in the mapping.

 Generally table items are mapped using class -> cell mapping semantics. This is configured
 via invocation of [ORKTableController mapObjectClass:toTableCellClass:]. Default mappings for
 ORKTableItem instances are configured on your behalf when you invoke the [ORKTableView loadTableItems:]
 family of methods.
 ...
 **Default**: nil
 */
@property (nonatomic, retain) ORKTableViewCellMapping *cellMapping;

/**
 Return a new array of ORKTableItem instances given a nil terminated list of strings.
 ...
 */
+ (id)tableItemUsingBlock:(void (^)(ORKTableItem *tableItem))block;
...
/**
 ...
 For example:
    ...
    NSArray *tableItems = [NSArray arrayWithObjects:[MyTableItem tableItemWithText:@"Foo"
                                                                        usingBlock:^(ORKTableItem *tableItem) {
                                                                            [(MyTableItem *)tableItem setURL:@"app://whatever"];
                                                                        }], ...];
 */
+ (id)tableItemWithText:(NSString *)text usingBlock:(void (^)(ORKTableItem *tableItem))block;
...
/**
 ...
 When invoked, an instance of ORKTableViewCellMapping will be created on your behalf
