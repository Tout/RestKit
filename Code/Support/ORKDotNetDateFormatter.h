 ...
 */
@interface ORKDotNetDateFormatter : NSDateFormatter {
    NSRegularExpression *dotNetExpression;
}

/**
 Instantiates an autoreleased ORKDotNetDateFormatter object with the timezone set to UTC
 (Greenwich Mean Time).

 @return An autoreleased ORKDotNetDateFormatter object
 @see dotNetDateFormatterWithTimeZone
 */
+ (ORKDotNetDateFormatter *)dotNetDateFormatter;

/**
 Instantiates an autoreleased ORKDotNetDateFormatter object.
 ...
 */
+ (ORKDotNetDateFormatter *)dotNetDateFormatterWithTimeZone:(NSTimeZone *)timeZone;
