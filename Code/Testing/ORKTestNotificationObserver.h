...
/**
 An ORKTestNotificationObserver object provides support for awaiting a notification
 ...
 */
@interface ORKTestNotificationObserver : NSObject
 ...
 */
+ (ORKTestNotificationObserver *)notificationObserverForName:(NSString *)notificationName object:(id)notificationSender;
