...
{
    ORKTestNotificationObserver *observer = [ORKTestNotificationObserver notificationObserverForName:name object:object];
    block();
...
+ (ORKTestNotificationObserver *)notificationObserver
{
    return [[[self alloc] init] autorelease];
}

+ (ORKTestNotificationObserver *)notificationObserverForName:(NSString *)notificationName object:(id)object
{
    ORKTestNotificationObserver *notificationObserver = [self notificationObserver];
    notificationObserver.object = object;
    notificationObserver.name = notificationName;
    return notificationObserver;
}

+ (ORKTestNotificationObserver *)notificationObserverForName:(NSString *)notificationName
{
