...
/**
 ...
 @see ORKObjectMappingTestExpectation
 */
 ...
 */
@property (nonatomic, strong, readonly) ORKObjectMapping *mapping;
...
/**
 ...
 @see [ORKObjectMapping mappableObjectForData:]
 */
